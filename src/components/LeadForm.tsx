    ...
    >
      <Card className="w-full max-w-[400px] bg-slate-900/50 backdrop-blur-xl border-slate-800 shadow-[0_20px_50px_rgba(0,0,0,0.5)] p-10 rounded-[40px] flex flex-col items-center justify-center gap-10 overflow-hidden relative group">
        ...
        <div className="text-center space-y-3 relative z-10">
           <h3 className="text-3xl font-display font-extrabold text-white tracking-tighter uppercase leading-none">Consult <br /> <span className="text-brand-primary">Pharmacist</span></h3>
        ...
        <div className="w-full space-y-4 relative z-10">
          ...
          >
            <a href="tel:+919496358682" className="flex items-center justify-center gap-3">
              Call Support
              <Phone className="h-5 w-5 group-hover/call:rotate-12 transition-transform text-brand-primary" />
            </a>
          </Button>
        </div>

        <div className="pt-4 border-t border-white/5 w-full text-center">
          <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.2em]">Response time: &lt; 5 mins</p>
        </div>
      </Card>
    </motion.div>
  );
